...
if ($id <= 0) {
    redirect_to('tab5.php?action=list_tab5&error=معرف غير صالح');
}

// Chargement du tableau principal
$tableau = Tableau5::trouve_par_id($id);
if (!$tableau) {
    redirect_to('tab5.php?action=list_tab5&error=الجدول غير موجود');
}
...
if (!$societe) {
    redirect_to('tab5.php?action=list_tab5&error=المؤسسة غير موجودة');
}
if ($current_user->type == 'utilisateur' && $current_user->id_societe != $societe->id_societe) {
    redirect_to('tab5.php?action=list_tab5&error=غير مصرح بالاطلاع على هذا الجدول');
}
...
$titre = "طباعة الجدول 5 - " . $societe->raison_ar . " - " . $annee;
?>
<!DOCTYPE html>
...
<body>
    <div class="print-container">
        ...
        <div class="republic-header">
            ...
            <div class="document-ref">الجدول رقم : 05</div>
            <div class="document-ref">      رزنامة تلخيصية لعمليات التسيير التوقعي للموارد البشرية   </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th rowspan="2" class="align-middle">الدرجة</th>
                        <th colspan="3" class="text-center">التوظيف الخارجي</th>
                        <th colspan="3" class="text-center">التوظيف الداخلي</th>
                        <th rowspan="2" class="align-middle">مسابقة التأهيل</th>
                        <th rowspan="2" class="align-middle">جدول رفع المستوى</th>
                        <th rowspan="2" class="align-middle">لجنة التركيب</th>
                    ...
                    <tr>
                        <th>مسابقة/امتحان</th>
                        <th>مسابقة على أساس الدبلوم</th>
                        <th>مسابقة إعادة التأهيل</th>
                        <th>مسابقة مهنية</th>
                        <th>امتحان مهني</th>
                        <th>قائمة الترشيح</th>
                    </tr>
