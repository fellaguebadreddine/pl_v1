...
try {
    ...
    $detail = DetailTab2_2::trouve_par_id($id);
    ...
    // ==============================
    $details = DetailTab2_2::trouve_tableeu_vide($id_societe, $id_user);
