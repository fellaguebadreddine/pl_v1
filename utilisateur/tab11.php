...
$titre = "الجدول 11 -     ";
$active_menu = "tab_11";
$active_submenu = "tab_11";
$header = array('select2', 'sweetalert2');
require_once("composit/header.php");

$annee = $exercice_actif ? $exercice_actif->annee : date('Y');
$existe = Tableau11::existe_pour_societe_annee($societe->id_societe, $annee);
$tabls = Tableau11::trouve_par_societe($societe->id_societe);

if ($action == "add_tab11") {
    if ($existe) redirect_to("?action=list_tab11");
}
?>
                ...
                <div class="card mb-4">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        ...
                        <?php if ($exercice_actif && !$existe): ?>
                            <a href="#" class="btn btn-primary"><i class="fas fa-plus me-1"></i> إضافة جدول رقم 11</a>
                        <?php elseif ($existe):
                            $tab_existant = Tableau11::trouve_par_societe_annee($societe->id_societe, $annee);
