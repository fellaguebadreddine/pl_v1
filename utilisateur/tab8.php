...
$existe = Tableau8::existe_pour_societe_annee($societe->id_societe, $annee);
$tabls = Tableau8::trouve_par_societe($societe->id_societe);

if ($action == "add_tab8") {
    if ($existe) redirect_to("?action=list_tab8");
}
?>
                ...
                <div class="card mb-4">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        ...
                        <?php if ($exercice_actif && !$existe): ?>
                            <a href="#" class="btn btn-primary"><i class="fas fa-plus me-1"></i> إضافة جدول رقم 8</a>
                        <?php elseif ($existe):
                            $tab_existant = Tableau8::trouve_par_societe_annee($societe->id_societe, $annee);
