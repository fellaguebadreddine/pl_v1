...
$titre = "الجدول 12 -     ";
$active_menu = "tab_12";
$active_submenu = "tab_12";
$header = array('select2', 'sweetalert2');
require_once("composit/header.php");

$annee = $exercice_actif ? $exercice_actif->annee : date('Y');
$existe = Tableau12::existe_pour_societe_annee($societe->id_societe, $annee);
$tabls = Tableau12::trouve_par_societe($societe->id_societe);

if ($action == "add_tab12") {
    if ($existe) redirect_to("?action=list_tab12");
}
?>
                ...
                <div class="card mb-4">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        ...
                        <?php if ($exercice_actif && !$existe): ?>
                            <a href="#" class="btn btn-primary"><i class="fas fa-plus me-1"></i> إضافة جدول رقم 12</a>
                        <?php elseif ($existe):
                            $tab_existant = Tableau12::trouve_par_societe_annee($societe->id_societe, $annee);
