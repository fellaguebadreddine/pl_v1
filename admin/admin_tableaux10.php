...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-10">
                    <h3 class="mb-0"><i class="fas fa-table me-2"></i>      الجدول 10   </h3>
                </div>
                <div class="col-sm-2">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="index.php">الرئيسية</a></li>
                        <li class="breadcrumb-item active">  جدول  010 </li>
                    </ol>
                </div>
            </div>
        </div>
               ...
               <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php 
                                    $tabls = Tableau10::trouve_par_societe($nav_societe->id_societe);
                                    if (!empty($tabls)): 
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            <a href="../utilisateur/print_tab10.php?id=<?php echo $row->id; ?>" class="btn btn-sm btn-primary text-white" target="_blank">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="details_tableau10.php?action=affchier_detail&id=<?php echo $row->id; ?>" 
                                               class="btn btn-sm btn-warning me-1" title="التفاصيل">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <button onclick="commentTableau10(<?php echo $row->id; ?>)" 
