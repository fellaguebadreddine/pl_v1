...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-10">
                    <h3 class="mb-0"><i class="fas fa-table me-2"></i> جدول رقم 01: جدول يتعلق بهيكل التعدادات إلى غاية : <?php echo '31-12-2025'; ?> </h3>
                </div>
                <div class="col-sm-2">
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($tabls)):
                                            foreach ($tabls as $row):
                                                $statut_badge = $row->statut == 'validé' ? 'success' : ($row->statut == 'en_attente' ? 'warning' : 'secondary');
                                        ?>
                                                <tr>
