        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="bord.php" <?php if ($active_menu == 'avancement_wilayas'){echo 'class="nav-link active"';}else{echo 'class="nav-link"';}?>>
                  <i class="fas fa-tasks"></i>
                  <p> لوحة التحكم</p>
                  <i class="nav-arrow bi bi-tasks"></i>
                </a>
              </li>              
              <li class="nav-item">
                <a href="parametres_exercice.php" <?php if ($active_menu == 'parametres'){echo 'class="nav-link active"';}else{echo 'class="nav-link"';}?>>
