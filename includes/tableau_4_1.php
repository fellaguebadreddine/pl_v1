...
class Tableau4_1 {
    protected static $nom_table="tableau_4_1";
	protected static $champs = array('id', 'id_societe', 'annee', 'statut', 'date_valide', 'id_user', 'commentaire_admin', 'id_admin_validateur', 'date_creation');
	public $id;	
	public $id_societe;
	public $statut;
	public $annee;
...
public static function trouve_par_criteres($criteres = []) {
   ...
   return  self::trouve_par_sql($q);
	...
	public static function trouve_tableau_4_par_id($id=0) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE id_societe={$id} LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
