...
// Tableau1.php
class DetailTab1_hp {
    protected static $nom_table="detail_tab_1_hp";
	protected static $champs = array('id', 'id_societe', 'id_tab_1', 'annee', 'id_user', 'code','id_grade_hp','postes_total_hp','postes_reel_hp', 'poste_intirim_hp', 'poste_femme_hp', 'difference_hp', 'observations_hp', 'date_tabl_hp', 'total_hf_postes_total', 'total_hp_postes_reel','total_hp_poste_intirim', 'total_hp_poste_femme', 'total_hp_difference');
	public $id;	
	public $id_societe;
	public $id_tab_1;
	public $annee;
	...
	public $code;
	public $id_grade_hp;
	public $postes_total_hp;
	public $postes_reel_hp;
    public $poste_intirim_hp;
    public $poste_femme_hp;
    public $difference_hp;
    public $observations_hp;
    public $date_tabl_hp;
	public $total_hp_postes_total;
	public $total_hp_postes_reel;
	public $total_hp_poste_intirim;
	public $total_hp_poste_femme;
	public $total_hp_difference;
	...
	public static function trouve_par_tableau($id_tab_1)
{
    ...
    public static function supprimer($id) {
        global $bd;
        $result = $bd->requete("DELETE FROM ".self::$nom_table." WHERE id = $id", array($id));
        return $result !== false;
    }
